...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--callers-evaluation-folder', type=str, help='Callers evaluation folder path (the same folder that was provided to the ONCOLINER improvement module)')
